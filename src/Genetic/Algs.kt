...
class Algs {
    ...
    public fun fillKnapsackDynamic(load: Int, items: List<Item>, storage: HashMap<LoadCount, Fill> = hashMapOf()): Fill {
    ...
    public fun fillKnapsackGreedy(load: Int, items: List<Item>): Fill {
